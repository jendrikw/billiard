...
class Ball {
    ...
    remove() {
    	...
    	this.x = Table.HOLED_BALLS_TOP_LEFT_X + xDistance * Ball.RADIUS * 2; // The holed balls have to be lined up under the game-table.
		this.y = Table.HOLED_BALLS_TOP_LEFT_Y + Table.HOLED_BALLS_HEIGHT / 2;
